	...
	<view class="uni-cursor-point">
		...
		<view :class="{
		  ...
		  'clicked-waiting': clickWaiting
			...
			<uni-icons class="fab-circle-icon" :type="styles.icon" :color="styles.iconColor" size="32" :class="{'uni-fab__plus--active': isShow && content.length > 0}"></uni-icons>
