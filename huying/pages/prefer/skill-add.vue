	...
	<view class="page">
		<view class="form-card">
			<view class="form-item">
				<text class="form-item__label">发证机构<text class="form-item__required">*</text></text>
				<input class="form-item__input" v-model="form.issuing_authority" placeholder="请输入发证机构" />
			</view>
			<view class="form-item">
				<text class="form-item__label">技能等级<text class="form-item__required">*</text></text>
				<input class="form-item__input" v-model="form.level" placeholder="请输入技能等级" />
			</view>
			<view class="form-item">
				<text class="form-item__label">技能名称<text class="form-item__required">*</text></text>
				<input class="form-item__input" v-model="form.name" placeholder="请输入技能名称" />
			</view>
			<view class="form-item">
...
<script setup>
	...
	const form = reactive({ issuing_authority: '', level: '', name: '', award_time: '' })
	const certImg = ref('')
	...
	const handleSubmit = async () => {
		if (!form.issuing_authority) { uni.showToast({ title: '请输入发证机构', icon: 'none' }); return }
		if (!form.level) { uni.showToast({ title: '请输入技能等级', icon: 'none' }); return }
		if (!form.name) { uni.showToast({ title: '请输入技能名称', icon: 'none' }); return }
